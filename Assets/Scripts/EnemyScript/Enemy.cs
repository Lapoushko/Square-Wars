...
public class Enemy : MonoBehaviour
{
    ...
    public void TakeDamage()
    {
        ...
        if (health <= 0)
        {
            ...
            //GameObject prefabScore = Instantiate(ParticleScore);
            //prefabScore.transform.parent = gameObject.transform;
            //prefabScore.transform.localPosition = gameObject.transform.localPosition;
            Destroy(gameObject);
